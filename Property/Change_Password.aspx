                        ...
                        <div id="divpassword" runat="server" >
                          ...
                          <div class="property-type-module medium-module">
                            ...
                            <div class="login_input">
                                ...
                                <asp:Button ID="btnChange" ValidationGroup="SaveRegInfo" runat="server" Style="clear: none; width:9%; float:left;" CssClass="mrgn_btnn" Text="Submit" OnClick="btnChange_Click" />
                            </div>
                            </div>
                            </div>
